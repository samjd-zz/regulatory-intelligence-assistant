		...
		<div className="flex flex-col h-full animate-fade-in">
			...
			<div className="mb-8 pb-8 border-b border-slate-100 dark:border-zinc-800">
				<div className="flex flex-wrap justify-between w-full gap-y-2">
					{/* Impact & Social Good */}
					<div className="flex items-center gap-2 px-4 py-1 bg-blue-50/50 dark:bg-blue-900/10 border border-blue-100/50 dark:border-blue-800/20">
						<svg
					...
					{/* Interoperability */}
					<div className="flex items-center gap-2 px-4 py-1 bg-violet-50/50 dark:bg-violet-900/10 border border-violet-100/50 dark:border-violet-800/20">
						<svg
							...
							viewBox="0 0 24 24"
						>
							<title>Interoperability Icon</title>
							<path
								strokeLinecap="round"
								strokeLinejoin="round"
								strokeWidth={2}
					...
					{/* Explainability */}
					<div className="flex items-center gap-2 px-4 py-1 bg-amber-50/50 dark:bg-amber-900/10 border border-amber-100/50 dark:border-amber-800/20">
						<svg
							...
							viewBox="0 0 24 24"
						>
							<title>Explainability Icon</title>
							<path
								strokeLinecap="round"
								strokeLinejoin="round"
								strokeWidth={2}
					...
					{/* Scalability */}
					<div className="flex items-center gap-2 px-4 py-1 bg-emerald-50/50 dark:bg-emerald-900/10 border border-emerald-100/50 dark:border-emerald-800/20">
						<svg
					...
					{/* Accessibility */}
					<div className="flex items-center gap-2 px-4 py-1 bg-rose-50/50 dark:bg-rose-900/10 border border-rose-100/50 dark:border-rose-800/20">
						<svg
					...
					{/* Usability */}
					<div className="flex items-center gap-2 px-4 py-1 bg-cyan-50/50 dark:bg-cyan-900/10 border border-cyan-100/50 dark:border-cyan-800/20">
						<svg
							className="w-3.5 h-3.5 text-cyan-500 dark:text-cyan-400"
							fill="none"
							stroke="currentColor"
							viewBox="0 0 24 24"
						>
			...
			<div className="grid grid-cols-12 gap-12 md:gap-24 h-full">
					...
					<div className="mb-auto">
							...
							<div className="flex items-start gap-3">
								<div className="shrink-0 mt-0.5">
									<svg
										...
										viewBox="0 0 24 24"
									>
										<title>Responsible AI Icon</title>
										<path
											strokeLinecap="round"
											strokeLinejoin="round"
											strokeWidth={2}
						...
						<div className="mt-8 animate-slide-up delay-400">
							...
							<div className="w-full h-48 flex items-end justify-between gap-6 max-w-2xl">
								...
								>
									<span className="absolute -top-8 left-1/2 -translate-x-1/2 bg-teal-600 text-white text-[10px] font-bold px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0">
										NOW
									</span>
								</div>
							</div>
				...
				<div className="col-span-12 lg:col-span-7 flex flex-col justify-between">
					...
					<div className="mt-10 pt-8 border-t border-slate-200 dark:border-zinc-800 animate-slide-up delay-350">
						<div className="flex items-center gap-3 mb-6">
							<div className="p-2 pl-0">
								<svg
									...
									viewBox="0 0 24 24"
								>
									<title>System Architecture Icon</title>
									<path
										strokeLinecap="round"
										strokeLinejoin="round"
										strokeWidth={1.5}
											...
											<div className="space-y-1.5">
												...
												<div className="flex items-center gap-1.5">
													...
													>
														...
														<path d="M13.983 11.078h2.119a.186.186 0 00.186-.185V9.006a.186.186 0 00-.186-.186h-2.119a.185.185 0 00-.185.185v1.888c0 .102.083.185.185.185m-2.954-5.43h2.118a.186.186 0 00.186-.186V3.574a.186.186 0 00-.186-.185h-2.118a.185.185 0 00-.185.185v1.888c0 .102.082.185.185.185m0 2.716h2.118a.187.187 0 00.186-.186V6.29a.186.186 0 00-.186-.185h-2.118a.185.185 0 00-.185.185v1.887c0 .102.082.186.185.186m-2.93 0h2.12a.186.186 0 00.184-.186V6.29a.185.185 0 00-.185-.185H8.1a.185.185 0 00-.185.185v1.887c0 .102.083.186.185.186m-2.964 0h2.119a.186.186 0 00.185-.186V6.29a.185.185 0 00-.185-.185H5.136a.186.186 0 00-.186.185v1.887c0 .102.084.186.186.186m5.893 2.715h2.118a.186.186 0 00.186-.185V9.006a.186.186 0 00-.186-.186h-2.118a.185.185 0 00-.185.185v1.888c0 .102.082.185.185.185m-2.93 0h2.12a.185.185 0 00.184-.185V9.006a.185.185 0 00-.184-.186h-2.12a.185.185 0 00-.184.185v1.888c0 .102.083.185.185.185m-2.964 0h2.119a.185.185 0 00.185-.185V9.006a.185.185 0 00-.185-.185V9.006a.185.185 0 00-.184-.186h-2.12a.186.186 0 00-.186.186v1.887c0 .102.084.185.186.185m-2.92 0h2.12a.185.185 0 00.184-.185V9.006a.185.185 0 00-.184-.186h-2.12a.185.185 0 00-.184.185v1.888c0 .102.082.185.185.185M23.763 9.89c-.065-.051-.672-.51-1.954-.51-.338 0-.676.03-1.01.087-.248-1.7-1.653-2.53-1.716-2.566l-.344-.199-.226.327c-.284.438-.49.922-.612 1.43-.23.97-.09 1.882.403 2.661-.595.332-1.55.413-1.744.42H.751a.751.751 0 00-.75.748 11.376 11.376 0 00.692 4.062c.545 1.428 1.355 2.48 2.41 3.124 1.18.723 3.1 1.137 5.275 1.137.983.003 1.963-.086 2.93-.266a12.248 12.248 0 003.823-1.389c.98-.567 1.86-1.288 2.61-2.136 1.252-1.418 1.998-2.997 2.553-4.4h.221c1.372 0 2.215-.549 2.68-1.009.309-.293.55-.65.707-1.046l.098-.288Z" />
													</svg>
													<span className="text-[10px] text-slate-600 dark:text-zinc-400">
														Docker
													</span>
												...
												<div className="space-y-1.5">
													<div className="flex items-center gap-1.5">
														...
														>
															...
															<path d="M12 0c6.627 0 12 2.686 12 6v12c0 3.314-5.373 6-12 6s-12-2.686-12-6V6c0-3.314 5.373-6 12-6zm0 2C7.03 2 3 3.79 3 6s4.03 4 9 4 9-1.79 9-4-4.03-4-9-4z" />
														</svg>
														<span className="text-[10px] text-slate-600 dark:text-zinc-400">
															Neo4j Graph
														</span>
													...
													<div className="flex items-center gap-1.5">
														...
														>
															...
															<path d="M10.5 19.5h3v-3h-3v3zm0-15v3h3v-3h-3zM21 12v-1.5l-2.25-.75.75-2.25L18 6l-1.5 1.5-2.25-.75H13.5v3h3.75l.75 2.25L19.5 12h1.5zm-18 0l1.5-2.25.75-2.25H9v-3H5.25L3 6l-1.5 1.5L2.25 9.75 3 12h-.001zm0 1.5l-.75 2.25L3 18l1.5 1.5 2.25.75H10.5v-3H6.75l-.75-2.25L4.5 13.5H3zm15 0h1.5l.75 2.25 1.5 1.5 2.25.75L21 18l-.75-2.25L19.5 13.5H18v1.5zm-7.5 3h3v-3h-3v3z" />
														</svg>
														<span className="text-[10px] text-slate-600 dark:text-zinc-400">
															Elasticsearch
														</span>
						...
						<div className="mt-6 flex flex-wrap items-center gap-3">
							...
							<div className="flex items-center gap-2 px-3 py-1.5 border border-slate-200 dark:border-zinc-700 group hover:border-teal-500/30 transition-colors cursor-default">
								<svg
									...
									viewBox="0 0 24 24"
								>
									<title>JSON Responses Icon</title>
									<path
										strokeLinecap="round"
										strokeLinejoin="round"
										strokeWidth={2}
					...
					<div className="mt-8 animate-slide-up delay-450">
						<div className="flex items-center justify-between mb-0">
							...
							<div className="flex gap-2">
								<button
									type="button"
									className="p-1 hover:bg-slate-100 dark:hover:bg-zinc-700 transition-colors"
									title="Yes, helpful"
								>
									<svg
										className="w-4 h-4 text-slate-400 dark:text-zinc-500 hover:text-teal-600 dark:hover:text-teal-400"
										fill="none"
										stroke="currentColor"
										viewBox="0 0 24 24"
									>
