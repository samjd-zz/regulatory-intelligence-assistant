		...
		<div className="flex flex-col h-full animate-fade-in">
			...
			<div className="grid grid-cols-12 gap-12 md:gap-24 h-full">
				...
				<div className="col-span-12 lg:col-span-7 flex flex-col justify-between">
					...
					<div className="grid grid-cols-2 gap-12 md:gap-24">
						<div className="animate-slide-up delay-200">
							...
							<div className="mt-2 flex items-center gap-2">
								<span className="text-[10px] bg-teal-50 dark:bg-teal-900/30 text-teal-700 dark:text-teal-400 px-2 py-0.5 rounded-full font-medium">
									High Confidence
								</span>
								<button
									type="button"
					...
					<div className="grid grid-cols-2 gap-6 mt-8 animate-slide-up delay-350">
						<div className="p-3">
							<div className="flex items-center gap-2 mb-2">
								<svg
									className="w-3.5 h-3.5 text-slate-600 dark:text-zinc-400"
									fill="none"
									stroke="currentColor"
									viewBox="0 0 24 24"
								>
							...
							<div className="flex flex-col gap-1">
								<div className="flex items-center gap-1.5">
									<svg
										className="w-3 h-3 text-slate-500 dark:text-zinc-500"
										viewBox="0 0 24 24"
										fill="currentColor"
									>
						...
						<div className="p-3">
							<div className="flex items-center gap-2 mb-2">
								<svg
									...
									viewBox="0 0 24 24"
								>
									<title>Scalable Architecture Icon</title>
									<path
										strokeLinecap="round"
										strokeLinejoin="round"
										strokeWidth={2}
							...
							<div className="flex flex-col gap-1">
								...
								<div className="flex items-center gap-1.5">
									<svg
										...
										fill="currentColor"
									>
										<title>Elasticsearch Icon</title>
					...
					<div className="mt-8 p-4 bg-slate-50 dark:bg-zinc-800/50 border border-slate-100 dark:border-zinc-800 rounded-lg animate-slide-up delay-375">
						...
						<div className="grid grid-cols-2 gap-3">
							<div>
								<p className="text-[9px] text-slate-500 dark:text-zinc-400 font-semibold uppercase mb-1">
									Backend
								</p>
								<div className="flex flex-col gap-1">
									<div className="flex items-center gap-1.5">
							...
							<div>
								...
								<div className="flex flex-col gap-1">
									<div className="flex items-center gap-1.5">
										<svg
											className="w-3 h-3 text-cyan-500 dark:text-cyan-400"
											viewBox="0 0 24 24"
											fill="currentColor"
										>
