...
def upgrade() -> None:
    ...
    # Drop indexes on generated columns first
    ...
    # Drop generated columns (they depend on other columns like 'title')
    op.drop_column('regulations', 'search_vector')
    op.drop_column('regulations', 'search_vector_fr')
    
    # Now we can safely alter other columns
    ...
    # Drop indexes on generated columns first for sections table
